...
const ContactPage = () => {
  ...
  const contactOptions = [
    ...
    },
    {
      ...
      title: 'Instagram',
      description: 'See our work & send a DM',
      linkText: '@the_hoodbarber1 →',
    ...
    },
    {
      ...
      title: 'TikTok',
      description: 'Follow for fresh content',
      linkText: '@mtbcutz →',
            ...
            {contactOptions.map((option, index) => (
              <div
                ...
                className="bg-brand-surface border border-white/5 rounded-sm p-6 text-center
                           hover:border-brand-red/30 hover:bg-brand-surface/80 transition-all duration-300"
              >
                <div className="text-brand-red mx-auto mb-4">
                  {option.icon}
                </div>
